...
/// By using {} and required or nullable takes two named parameters which are string and int
...
void requiredNamedMethod(int age, String? name, {required double height}) {
  if (name != null) {
    print(
      'I am $age years old, my height is ${height.toStringAsFixed(2)}, Name is $name',
    );
  } else {
    print(
      'I am $age years old, my height is ${height.toStringAsFixed(2)}, No name',
    );
  }
}
