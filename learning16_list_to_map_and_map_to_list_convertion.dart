void main() {
  ...
  Map<String, dynamic> person = {'id': 01, 'job': 'Developer', 'salary': 20.50};
  ...
  List<List<dynamic>> kvList = person.entries
      .map((e) => [e.key, e.value])
      .toList();
  ...
  List<Map<String, dynamic>> mappedList = person.entries
      .map((e) => {e.key: e.value})
      .toList();
  ...
  /// Using .fromEntries() to convert a List of MapEntry()'s to Map
  var entryList1 = [
    MapEntry('id', 1),
  ...
  var person3 = {for (var m in mappedList1) ...m};
