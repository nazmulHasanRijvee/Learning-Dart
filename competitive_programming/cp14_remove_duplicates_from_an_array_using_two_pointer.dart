...
void main() {
  ...
  int write =
      1; // starts from 1 because 0 index is already unique and no previous element to compare to
  for (int i = 1; i < numbers.length; i++) {
    if (numbers[i] != numbers[write - 1]) {
      // while loop use because after each pop loop length changes
